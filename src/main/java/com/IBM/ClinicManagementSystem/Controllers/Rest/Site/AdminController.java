...
import com.IBM.ClinicManagementSystem.Mappers.Site.AdminMapper;
import com.IBM.ClinicManagementSystem.Models.Entities.User;
import com.IBM.ClinicManagementSystem.Repositories.Mysql.AdminRepository;
...
public class AdminController {
    ...
    @GetMapping("/test")
    public ResponseEntity<ApiResponse<AdminDTO>> getAdmin(@AuthenticationPrincipal CustomUserDetails userDetails){
        return ResponseEntity.ok(ApiResponse.success(
                adminMapper.toDTO(
                        adminRepository.findById(userDetails.getId()).get())
